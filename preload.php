...
require __DIR__.'/ci/app/Config/Paths.php';
  ...
  private array $paths = [
    [
      ...
      'exclude' => [
        ...
        '/ci/system/Database/OCI8/',
        '/ci/system/Database/Postgre/',
        '/ci/system/Database/SQLSRV/',
        // Not needed.
        '/ci/system/Database/Seeder.php',
        '/ci/system/Test/',
        '/ci/system/Language/',
        '/ci/system/CLI/',
        '/ci/system/Commands/',
        '/ci/system/Publisher/',
        '/ci/system/ComposerScripts.php',
        '/ci/Views/',
        // Errors occur.
        '/ci/system/Config/Routes.php',
        '/ci/system/ThirdParty/',
      ],
    ],
  ];
